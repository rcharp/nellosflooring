...
const BradentonPage = () => {
  useSEO({
    ...
    description: "Professional HVAC services in Bradenton FL. AC repair, installation, maintenance & duct cleaning. Family owned, licensed & insured. Call (941) 258-4006.",
