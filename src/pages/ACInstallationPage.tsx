...
const ACInstallationPage = () => {
  useSEO({
    ...
    description: "Professional AC installation in Palmetto & Bradenton. Energy-efficient systems, upfront pricing, manufacturer warranties. Call Emmons Air at (941) 258-4006.",
